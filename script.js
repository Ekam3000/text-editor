...
onload = function () {
    ...
    textbox.oninput = function(event){
        console.log(event);  // on console u can se the details of these events 
        ...
        temptext.innerHTML = "On stack "+stack.top()+"<br>"+temptext.innerHTML; // on insert and delete 
        text = textbox.value;
    };
    ...
    undo.onclick = function () {
        ...
        if(operation[0]!==-1){
            temptext.innerHTML = "Performing undo operation<br>"+temptext.innerHTML; // textbox will just display "Performing undo operation + the [revious temptext content]
            if(operation[0] === 0){
